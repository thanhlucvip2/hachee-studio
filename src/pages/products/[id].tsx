        ...
        <div className="bg-lightgreen h-16 w-full flex items-center border-t-2 border-gray200">
          <div className="app-x-padding app-max-width w-full">
            <div className="breadcrumb">
              ...
              /{" "}
              <Link legacyBehavior href={`/product-category/${product.categoryName}`}>
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  let product: itemType = {
    ...
    name: "product.name",
    price: 100000,
    img1: "https://giadinh.mediacdn.vn/2017/photo-0-1503452666516.jpg",
    img2: "https://giadinh.mediacdn.vn/2017/photo-0-1503452666516.jpg",
